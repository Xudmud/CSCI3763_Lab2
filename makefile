...
_SERVDEPS = catalog.h download.h spwd.h upload.h functions.h
SERVDEPS = $(patsubst %,$(SERVIDIR)/%,$(_SERVDEPS))
_SERVOBJ = main.o catalog.o download.o spwd.o upload.o functions.o
...
_CLIDEPS = catalog.h download.h ls.h pwd.h spwd.h upload.h functions.h
CLIDEPS = $(patsubst %,$(CLIIDIR)/%,$(_CLIDEPS))
_CLIOBJ = main.o catalog.o download.o ls.o pwd.o spwd.o upload.o functions.o
